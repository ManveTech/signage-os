    ...
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-5 text-left relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        {playlists.map(playlist => {
          ...
          return (
            <div key={playlist.id} className="bg-white rounded-2xl border border-gray-200 p-3.5 sm:p-5 hover:shadow-md transition-all flex flex-col justify-between space-y-3 sm:space-y-4">
