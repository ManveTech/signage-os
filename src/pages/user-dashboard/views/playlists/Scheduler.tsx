          ...
          <div key={s.id} className="bg-white rounded-2xl border border-slate-150 p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs hover:border-slate-300 transition-all duration-300">
            <div className="flex items-start gap-3.5">
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-slate-450 font-bold">
            ...
            <div className="flex gap-2 shrink-0 sm:ml-auto">
              <button 
                ...
                className="px-3.5 py-2 text-xs font-bold text-slate-650 bg-slate-100 hover:bg-slate-200 rounded-xl transition-all cursor-pointer"
              >
                Edit
              </button>
              <button 
                onClick={() => handleCancelSchedule(s)} 
                className="px-3.5 py-2 text-xs font-bold text-red-650 bg-red-50 hover:bg-red-100 rounded-xl transition-all cursor-pointer"
              >
                Delete
              </button>
            </div>
